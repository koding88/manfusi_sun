...
console.log(`orderNumber: ${row9.orderNumber}`);
console.log(`productType: ${row9.productType}`);
console.log(`productName: ${row9.productName}`);
console.log(`powerDetails: ${row9.powerDetails}`);
console.log(`equipmentDetails: ${row9.equipmentDetails}`);
console.log(`storage: ${row9.storage}`);
console.log(`kwpNumber: ${row9.kwpNumber}`);
console.log(`unitPrice: ${row9.unitPrice}`);
console.log(`listedPrice: ${row9.listedPrice}`);
console.log(`monthlyDiscountPercentage: ${row9.monthlyDiscountPercentage}`);
console.log(`priceWithVatAfterDiscount: ${row9.priceWithVatAfterDiscount}`);
console.log(`unitPricePerKwAfterDiscount: ${row9.unitPricePerKwAfterDiscount}`);
console.log(
    `minimumDownPaymentPercentage: ${row9.minimumDownPaymentPercentage}`
);
console.log(`minimumDownPaymentAmount: ${row9.minimumDownPaymentAmount}`);
console.log(`installmentAmount: ${row9.installmentAmount}`);
console.log(`minimumMonthlyInstallment: ${row9.minimumMonthlyInstallment}`);
console.log(`maximumMonthlyInstallment: ${row9.maximumMonthlyInstallment}`);
console.log(`minimumRoofInstallationArea: ${row9.minimumRoofInstallationArea}`);
console.log(`totalKwhProducedIn30Years: ${row9.totalKwhProducedIn30Years}`);
console.log(`totalSavingsIn30Years: ${row9.totalSavingsIn30Years}`);
console.log(`returnOnInvestmentYears: ${row9.returnOnInvestmentYears}`);
console.log(`averageMonthlyKwhProduction: ${row9.averageMonthlyKwhProduction}`);
console.log(`averageMonthlySavings: ${row9.averageMonthlySavings}`);
console.log(`firstYearSavings: ${row9.firstYearSavings}`);
console.log(`suitableForFamily80Percent: ${row9.suitableForFamily80Percent}`);
console.log(`suitableForFamily50Percent: ${row9.suitableForFamily50Percent}`);
console.log(
    `suitableForFamilyMonthly: ${row9.suitableForFamilyMonthly.min} - ${row9.suitableForFamilyMonthly.max}`
);
